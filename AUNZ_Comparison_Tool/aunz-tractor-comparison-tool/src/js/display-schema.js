...
export const displaySchema = [
  ...
  { key: 'powerBasis', propertyPath: 'powerBasis', label: 'Power basis', section: 'Derived performance', order: 3, unit: null, valueType: 'string', blankValue: '—', numericDeltaEligible: false, priority: false, sourceType: 'derived', formatter: 'text', nullable: true },
  { key: 'weightBasis', propertyPath: 'weightBasis', label: 'Weight basis', section: 'Derived performance', order: 4, unit: null, valueType: 'string', blankValue: '—', numericDeltaEligible: false, priority: false, sourceType: 'derived', formatter: 'text', nullable: true },
  { key: 'powerToWeightUnavailableReason', propertyPath: 'powerToWeightUnavailableReason', label: 'Unavailable reason', section: 'Derived performance', order: 5, unit: null, valueType: 'string', blankValue: '—', numericDeltaEligible: false, priority: false, sourceType: 'derived', formatter: 'text', nullable: true },
